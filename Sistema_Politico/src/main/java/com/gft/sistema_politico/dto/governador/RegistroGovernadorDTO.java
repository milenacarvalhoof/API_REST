...
public class RegistroGovernadorDTO {
	...
	public RegistroGovernadorDTO() {}

	public RegistroGovernadorDTO(String nome, String cpf, EnderecoDTO endereco, String telefone, Long partidoId,
