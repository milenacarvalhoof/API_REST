...
public class RegistroPrefeitoDTO {
	...
	public RegistroPrefeitoDTO() {}

	public RegistroPrefeitoDTO(String nome, String cpf, EnderecoDTO endereco, String telefone, Long partidoId,
