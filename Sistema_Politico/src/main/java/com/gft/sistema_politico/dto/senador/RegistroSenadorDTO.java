...
public class RegistroSenadorDTO {
	...
	public RegistroSenadorDTO() {}

	public RegistroSenadorDTO(String nome, String cpf, EnderecoDTO endereco, String telefone, Long partidoId,
