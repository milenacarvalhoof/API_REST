...
public class RegistroVereadorDTO {
	...
	public RegistroVereadorDTO() {}

	public RegistroVereadorDTO(String nome, String cpf, EnderecoDTO endereco, String telefone, Long partidoId,
